...
public class ASTProblem extends ASTNode implements IASTProblem {
    ...
    static {
    	...
    	errorMessages.put(new Integer(PREPROCESSOR_FOUND_USER_DEFINED_LITERAL),
    			ParserMessages.getString("ScannerProblemFactory.error.preproc.userdefinedLiteralInPP")); //$NON-NLS-1$
